                ...
                <html lang="en">
                    <head>
                        ...
                        <meta name="descripton"content="Omnifood is a premium food delivery service with a mission to bring affordable and helathy meals to as many as people as possible.">
                    ...
                    <body>
                                ...
                                <div class="col span-1-of-4 box">
                                   ...
                                   60+ top chefs
                                    ...
                                    <a href="#">@omnifood_lx</a>               
                                     ...
                                     <div class="col span-1-of-4 box">
                                   <img src="resources/images/san-francisco.jpg"alt="Sans Francisco">
                                    <h3>Sans Francisco</h3>
                                    <div class="city-feature">
                        ...
                        <div class="row">
                            ...
                            <div class="plan-box js--wp-4">
                                ...
                                <div>
                                <ul>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal every day
                                    </li>   
                                    <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 24/7
                                    </li>   
                            ...
                            <div class="plan-box">
                                ...
                                <div>
                                <ul>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal 10 days/month
                                    </li>   
                                    <li><i class="ion-ios-checkmark-empty icon-small"></i>Order 24/7
                                    </li>   
                                    <li><i class="ion-ios-checkmark-empty icon-small"></i>Access to newest creations
                            ...
                            <div class="plan-box">
                                ...
                                <div>
                                <ul>
                                <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meal
                                    </li>   
                                    <li><i class="ion-ios-checkmark-empty icon-small"></i>Order from 8 am to 12 pm
                                    </li>   
                              ...
                              <div class="row">
                                  ...
                                  <div class="row">
                                     ...
                                     if($_GET['success']==-1){
                                          ...
                                          Oops!Something went wrong.Pls try again later.</div>";
                                     }
                        ...
                        <div class="row">
                            ...
                            <ul class="social-links">
                             <li><a href="#"><i class="ion-social-facebook"></i></a></li>    <li><a href="#"><i class="ion-social-twitter"></i></a></li> 
                            <li><a href="#"><i class="ion-social-googleplus"></i></a></li>   <li><a href="#"><i class="ion-social-instagram"></i></a></li>                         
